...
SQLiteCustom: SQLiteCustom/src/sqlite3.h
	...
	echo 'CUSTOM_OTHER_SWIFT_FLAGS = -D SQLITE_ENABLE_PREUPDATE_HOOK -D SQLITE_ENABLE_FTS5 -DSQLITE_ENABLE_SNAPSHOT -DSQLITE_ENABLE_JSON1 -DSQLITE_ENABLE_JSONB' >> SQLiteCustom/GRDBCustomSQLite-USER.xcconfig
