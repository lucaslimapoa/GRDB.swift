...
SQLiteCustom: SQLiteCustom/src/sqlite3.h
	...
	echo 'CUSTOM_OTHER_SWIFT_FLAGS = -DSQLITE_ENABLE_PREUPDATE_HOOK -DSQLITE_ENABLE_FTS5 -DSQLITE_ENABLE_SNAPSHOT -DSQLITE_ENABLE_JSON1 -DGRDBCUSTOMSQLITE' >> SQLiteCustom/GRDBCustomSQLite-USER.xcconfig
	
	echo '// Makefile generated' > SQLiteCustom/src/SQLiteLib-USER.xcconfig
	echo 'CUSTOM_SQLLIBRARY_CFLAGS = -DSQLITE_ENABLE_PREUPDATE_HOOK -DSQLITE_ENABLE_FTS5 -DSQLITE_ENABLE_SNAPSHOT -DSQLITE_ENABLE_JSON1 -DGRDBCUSTOMSQLITE' >> SQLiteCustom/src/SQLiteLib-USER.xcconfig
